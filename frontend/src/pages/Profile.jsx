    ...
    return (
        <div className="app-layout min-h-screen bg-slate-950 text-slate-100 flex flex-col">
            ...
            <div className="dashboard flex flex-1">
                <Sidebar />
                <div className="dashboard-content p-8 md:p-12 flex-1 max-w-4xl mx-auto">
                    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 md:p-8 shadow-xl space-y-8">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-6 pb-8 border-b border-slate-800">
                            {user?.photoURL ? (
                                ...
                                <div className="w-24 h-24 rounded-full bg-slate-800 border-2 border-slate-700 flex items-center justify-center text-slate-400 text-4xl shadow-inner">
                                    <User size={48} />
                                </div>
                            )}
                            <div className="text-center sm:text-left space-y-1">
                                <h2 className="text-2xl font-bold text-white">
                                    {user?.displayName || "Stadium Fan"}
                                </h2>
                                <p className="text-blue-400 text-sm font-medium">Verified Visitor</p>
                                <p className="text-xs text-slate-500">ID: {user?.uid || "UNKNOWN"}</p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="bg-slate-950 p-5 rounded-xl border border-slate-800/80 flex items-start gap-4">
                                ...
                                <div className="space-y-0.5">
                                    ...
                                    <div className="text-sm font-semibold text-slate-200">{user?.email || "N/A"}</div>
                                </div>
                            </div>
                            ...
                            <div className="bg-slate-950 p-5 rounded-xl border border-slate-800/80 flex items-start gap-4">
                                ...
                                <div className="space-y-0.5">
                                    <div className="text-xs text-slate-500 font-medium">Joined At</div>
                            ...
                            <div className="bg-slate-950 p-5 rounded-xl border border-slate-800/80 flex items-start gap-4">
                                ...
                                <div className="space-y-0.5">
                                    <div className="text-xs text-slate-500 font-medium">Role & Credentials</div>
                                    <div className="text-sm font-semibold text-slate-200">Guest Visitor</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="pt-6 border-t border-slate-800 flex justify-end">
                            <button
                                ...
                                className="flex items-center gap-2 px-5 py-2.5 bg-red-600/10 hover:bg-red-600/20 text-red-400 hover:text-red-300 border border-red-500/20 hover:border-red-500/30 rounded-xl font-medium transition cursor-pointer text-sm"
                            >
                                <LogOut size={16} />
                                Sign Out
                            </button>
